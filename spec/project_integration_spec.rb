...
#     fill_in('Project Name', :with => 'Teaching Ruby to Kids')
...
#     test_volunteer = Volunteer.new({:volunteer_name => 'Jasmine', :project_id => project_id, :id => nil})
#     test_volunteer.save
#     visit "/projects/#{project_id}"
#     click_link('Jasmine')
#     fill_in('Volunteer Name', :with => 'Jane')
